...
import { render, renderHook, screen, within, fireEvent, waitFor } from '@testing-library/react'
...
// nothing out. These are the stand-ins React Flow's testing guide gives; they
// are installed for this file only.
// ---------------------------------------------------------------------------
...
class MeasuringResizeObserver {
  ...
  observe(target: Element) {
    // The pan-zoom extent reads contentRect, which the guide's version omits.
